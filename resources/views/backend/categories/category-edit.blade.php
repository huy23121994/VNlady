		...
		<div class="content-wrapper" style="min-height: 351px;">
	        ...
	        <section class="content-header">
	          	...
	          	<ol class="breadcrumb">
		            ...
		            <li><a href="{{url('manager/category')}}"> Categories</a></li>
	        		...
	        		<div class="col-sm-12">
		        		<div class="nav-tabs-custom">
		        			<div class="box box-success">
				                ...
				                <!-- form start -->
				                <form action="{{url('manager/category/'.$category['id'].'/update')}}" role="form" method="post">
				                  <div class="box-body">
							  	...
							  	<div class="modal-dialog modal-sm">
							   	 	<div class="modal-content">
								      	...
								      	<div class="modal-body text-center">
								        	...
								        	<a href="{{url('manager/category/destroy/'.$category['id'])}}" class="btn btn-primary" id="delete">Yes</a>
								      	</div>
								    </div>
							  	</div>
							</div><!--END Small modal -->
